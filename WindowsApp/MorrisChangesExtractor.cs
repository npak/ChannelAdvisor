...
{
    public partial class MorrisChangesExtractor : Form
    {
       // private Vendor vendorInfo;

        public MorrisChangesExtractor()
        {
            InitializeComponent();

            OutputFolderText.Text = new DAL().GetSettingValue("MorrisChanges_OutputFolder");
        }
        ...
        {
            DAL dal = new DAL();
            txtExtractFileUrl.Text = dal.GetSettingValue("MorrisChanges_FileUrl");
            countOfProductsText.Text = dal.GetSettingValue("MorrisChanges_NumberOfProducts");
            FilePrefixText.Text = dal.GetSettingValue("MorrisChanges_FilePrefix");
        }
        ...
        private void SaveSettings()
        {
            ...
            {
                DAL dal = new DAL();
                dal.UpdateSetting("MorrisChanges_FileUrl", txtExtractFileUrl.Text);
                dal.UpdateSetting("MorrisChanges_NumberOfProducts", countOfProductsText.Text);
                dal.UpdateSetting("MorrisChanges_FilePrefix", FilePrefixText.Text);
            ...
            {                   
                try
                {
                   ...
                   // lblMessage.Text = "Converting csv files. Please wait...";
                    ...
                    DAL dal = new DAL();
                    string xmlUrl = dal.GetSettingValue("MorrisChanges_FileUrl");
                    Extractors.MorrisChangesExtractor extractor = new Extractors.MorrisChangesExtractor(GetEnteredValues(), 
                    ...
                    new DAL().UpdateSetting("MorrisChanges_OutputFolder", OutputFolderText.Text);
