...
{
    public partial class MorrisExtractor : Form
    {
       // private Vendor vendorInfo;

        public MorrisExtractor()
        {
            InitializeComponent();
        ...
        {
            DAL dal = new DAL();
            txtExtractFileUrl.Text = dal.GetSettingValue("MorrisExtractor_FileUrl");
            countOfProductsText.Text = dal.GetSettingValue("MorrisExtractor_NumberOfProducts");
            FilePrefixText.Text = dal.GetSettingValue("MorrisExtractor_FilePrefix");
        }
        ...
        private void SaveSettings()
        {
            ...
            {
                DAL dal = new DAL();
                dal.UpdateSetting("MorrisExtractor_FileUrl", txtExtractFileUrl.Text);
                dal.UpdateSetting("MorrisExtractor_NumberOfProducts", countOfProductsText.Text);
                dal.UpdateSetting("MorrisExtractor_FilePrefix", FilePrefixText.Text);
            ...
            {                   
                try
                {
                   ...
                   // lblMessage.Text = "Converting csv files. Please wait...";
                    ...
                    DAL dal = new DAL();
                    string xmlUrl = dal.GetSettingValue("MorrisExtractor_FileUrl");
                    Extractors.MorrisExtractor extractor = new Extractors.MorrisExtractor(GetEnteredValues(), 
                    ...
                    new DAL().UpdateSetting("MorrisExtractor_OutputFolder", OutputFolderText.Text);
