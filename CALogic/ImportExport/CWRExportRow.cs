...
namespace ChannelAdvisor
{
    ...
    public class CWRExportRow
    {
        ...
        public static CWRExportRow GetHeaderRow()
        {
            CWRExportRow lExportRow = new CWRExportRow();
            ...
            lExportRow.SellerCost = "Seller Cost";
            lExportRow.RetailPrice = "Retail Price";
            lExportRow.PictureURL = "Picture URLs";
